...
--start=${start} \
--end=${end} \
--GMMATmodelFile=${outdir}/${pop}_${ana}_gwas.saige-${strata}.rda \
--varianceRatioFile=${outdir}/${pop}_${ana}_gwas.saige-${strata}.varianceRatio.txt \
--SAIGEOutputFile=${outdir}/parts/${pop}_${ana}_gwas.saige-${strata}.vcf.dosage.chr${chr}.part${SGE_TASK_ID}.txt \
